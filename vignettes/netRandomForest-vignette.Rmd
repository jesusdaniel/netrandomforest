...
## JA: split the following packages into blocks, and introduce comments to explain why you need each package (simulations, comparisons, etc.)
...
## JA: whenever you mention a function or code variable in the text, use \texttt{functionName} to make the background look gray. You can also use dollar signs for equations and mathematical variables, like $n\times (n-1)$.
