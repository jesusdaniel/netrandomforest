...
## Obtain variable importance measures at K=5 clusters and q=0.4 for NRF2 (B=10) and the standard RF (B=1000) models.
num_clusters=5
...
## Train the NRF2 and standard RF models
...
## Plot the matrices of NRF2 and standard RF at q=0.4, respectively
